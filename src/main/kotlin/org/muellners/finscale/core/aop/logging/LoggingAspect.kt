package org.muellners.finscale.core.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(org.muellners.finscale.core.repository..*)" +
            " || within(org.muellners.finscale.core.service..*)" +
            " || within(org.muellners.finscale.core.web.rest..*)"
    )
